...
var InMemoryLocator = exports["default"] = /*#__PURE__*/function (_HandlerLocator) {
  function InMemoryLocator() {
    var _this;
    var handlers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, InMemoryLocator);
    _this = _callSuper(this, InMemoryLocator);
    _this.handlers = {};
    if (_lodash["default"].isObject(handlers)) {
      _this.handlers = _lodash["default"].reduce(handlers, function (carry, Handler, key) {
        carry[key] = _lodash["default"].isFunction(Handler) ? new Handler() : Handler; // eslint-disable-line
        return carry;
      }, {});
    }
    return _this;
