...
var HandleInflector = exports["default"] = /*#__PURE__*/function (_MethodNameInflector) {
  function HandleInflector(methodName) {
    var _this;
    _classCallCheck(this, HandleInflector);
    _this = _callSuper(this, HandleInflector);
    _this.methodName = methodName || 'handle';
    return _this;
  }
  _inherits(HandleInflector, _MethodNameInflector);
  return _createClass(HandleInflector, [{
    key: "inflect",
    value: function inflect(commandName, handler) {
      if (_lodash["default"].isFunction(handler[this.methodName]) === false) {
