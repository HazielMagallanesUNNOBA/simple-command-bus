...
var _Middleware2 = _interopRequireDefault(require("../Middleware.js"));
...
var LoggerMiddleware = exports["default"] = /*#__PURE__*/function (_Middleware) {
  function LoggerMiddleware(logger) {
    var _this;
    _classCallCheck(this, LoggerMiddleware);
    _this = _callSuper(this, LoggerMiddleware);
    _this.logger = logger;
    return _this;
  }
  _inherits(LoggerMiddleware, _Middleware);
  return _createClass(LoggerMiddleware, [{
    key: "execute",
